	...
	tracker : function(params) {
		...
		*/
		...
		function drawPoint(canvasContext, point, dp) {
            ...
            if(f < 300){
                for (var j = 0;j < pModel.shapeModel.eigenValues.length;j++) {
                    //console.log(Math.sqrt(pModel.shapeModel.eigenValues[j])*3);
                    //console.log(pModel.shapeModel.eigenValues[j]);
                }
                //console.log('----------------------');
            }
